...
//var big_list = List.fill((400000))(((scala.util.Random.nextFloat*100000).toInt.toString, (scala.util.Random.nextFloat*100000).toInt))
//var rr = new MapResampler(big_list)
//Vector.fill((10))(rr.resample()).groupBy(identity).mapValues(_.size)
// 1 to 20 foreach {_ =>
